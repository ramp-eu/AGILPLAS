...
If you'd like to contribute, start by searching through the [issues](https://github.com/ramp-eu/AGILPLAS/issues) and [pull requests](https://github.com/ramp-eu/AGILPLAS/pulls) to see whether someone else has raised a similar idea or question.
...
[Issues](https://github.com/ramp-eu/AGILPLAS/issues) and [Pull Requests](https://github.com/ramp-eu/AGILPLAS/pulls) sections. Anybody is welcome to join these conversations.
...
```bash
git clone https://github.com/your-github-username/AGILPLAS.git
```

3.  Add the main AGILPLAS repository as a remote to your forked repository (use any name for your remote repository, it does not have to be AGILPLAS, although we will use it in the next steps):

```bash
git remote add AGILPLAS https://github.com/ramp-eu/AGILPLAS.git
```

Before starting contributing, remember to synchronize the `master` branch in your forked repository with the `master` branch in the main AGILPLAS repository, by following this steps
